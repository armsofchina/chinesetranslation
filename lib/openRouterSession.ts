...
} from "@/lib/openRouterSessionCrypto";
export type {
  OpenRouterSession,
  SealedOpenRouterSession
} from "@/lib/openRouterSessionCrypto";
...
export const OPENROUTER_SESSION_KEY_COOKIE = "translation_vibe_openrouter_session_key";
...
export const getOpenRouterSessionKeyCookieOptions = (maxAge = 30 * 24 * 60 * 60) => ({
  httpOnly: true,
  secure: process.env.NODE_ENV === "production",
  sameSite: "lax" as const,
  path: "/api",
