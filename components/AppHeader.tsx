      ...
      <div className="flex items-center gap-2">
        <span
          className={`status-pill hidden sm:inline-flex ${
            connectionActive ? "bg-emerald-50 text-emerald-700 dark:bg-emerald-950/40 dark:text-emerald-200" : ""
          }`}
        >
          <span className={`h-1.5 w-1.5 rounded-full ${connectionActive ? "bg-emerald-500" : "bg-slate-400"}`} />
          {connectionLabel}
        </span>
